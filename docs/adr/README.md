...
| Platform ADR-007 — Gateway Rate Resilience | [`biosciences-mcp/docs/adr/proposed/`](https://github.com/open-biosciences/biosciences-mcp/tree/main/docs/adr/proposed) | Proposed 2026-09-02 (AGE-690). Codifies the backoff and headerless-throttle behaviour already implemented in the connectors and cited by [`psychology-mcp` constitution](https://github.com/open-biosciences/psychology-mcp/blob/main/.specify/memory/constitution.md) Principle VIII. |
